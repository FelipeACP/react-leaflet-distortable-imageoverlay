...
L.Map.BoxSelectHandle = L.Map.BoxZoom.extend({
  ...
  _finish: function () {
    this._map.boxSelector._box.parentNode.removeChild(this._map.boxSelector._box)
    //var box = document.querySelectorAll(this._map.boxSelector._box)
    //for (var i=0;i<box.length;i++)
     // if (box[i].innerHTML.length == 0)
